...
<ema:note:pandoc>
  ...
  <Header>
    <h1 class="mt-6 mb-4 text-4xl font-bold text-gray-700 border-b-2" />
    <h2 class="mt-6 mb-2 text-3xl font-bold text-gray-700" />
    <h3 class="mt-6 mb-2 text-2xl font-bold text-gray-700" />
    <h4 class="mt-6 mb-2 text-xl font-bold text-gray-700" />
    <h5 class="mt-6 mb-2 text-xl font-bold text-gray-700" />
  </Header>
  <Header:1>
    <h1 id="${header:id}" class="${header-class} text-4xl border-b-2">
      <heading-inlines-with-anchor />
    </h1>
  </Header:1>
  <Header:2>
    <h2 id="${header:id}" class="${header-class} text-3xl">
      <heading-inlines-with-anchor />
    </h2>
  </Header:2>
  <Header:3>
    <h3 id="${header:id}" class="${header-class} text-2xl">
      <heading-inlines-with-anchor />
    </h3>
  </Header:3>
  <Header:4>
    <h4 id="${header:id}" class="${header-class} text-xl">
      <heading-inlines-with-anchor />
    </h4>
  </Header:4>
  <Header:5>
    <h5 id="${header:id}" class="${header-class} text-lg">
      <heading-inlines-with-anchor />
    </h5>
  </Header:5>
  <Header:6>
