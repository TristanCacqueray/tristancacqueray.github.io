<!-- DoNotFormat -->
<bind tag="containerClass"><ema:metadata><value
      var="template.layout.note.containerClass"
    /></ema:metadata></bind>
<!-- DoNotFormat -->
    ...
    <div class="${containerClass}">
      <div class="mt-2 md:mt-4">
        ...
        <div class="relative md:shadow-2xl md:mb-8">
          ...
          <div class="flex-1 w-full overflow-x-auto bg-white">
            <main class="px-4 py-4">
              ...
              <script
                src="https://cdn.midirus.com/script/webamp.bundle.min.js"
                integrity="sha384-6L8JnEU7pQtPpwiqWZK5nqUzAwWxN9nAJyOinBQXjuG8DpqaSjIiEaCyOzay0YDi"
              ...
              <div style="min-height: 730px">
                ...
                <div id="info" style="width: 500px">
                  ...
                  <nav
                    id="my-release"
                    class="flex gap-1 p-1.5 pt-2 rounded-lg bg-white shadow-sm border border-slate-200"
                  >
                  </nav>
                </div>
                <script>
                  window.playlistClassNames =
                ...
                >
                  <p class="text-justify text-sm">
                    Free sounds to use for all your Creative Common or GPL
                    projects. No credit is required, but always appreciated.
                  </p>
                  <a
                    id="dl-btn"
                    download
                    target="_blank"
                    class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm mt-5 px-5 py-2.5 text-center me-2 mb-2 cursor-pointer hidden"
                  >Download FLAC</a>
                </div>
                <div
                  class="place-items-center flex flex-col"
                  style="position: absolute; top: 98px; right: 23px"
                >
                  <svg
                    o
                    height="40px"
		...
		l7.649-3.99C507.945,185.074,511.107,174.907,506.813,166.683z"
                  ...
                  <br />
                  <div
                    class="flex flex-col rounded-lg bg-white shadow-sm border border-slate-200"
                  >
                    <nav
                      id="my-playlist"
                      class="flex max-w-[120px] flex-col gap-1 p-1.5"
                    >
                    </nav>
                  </div>
                </div>
